...
## 풀고난 후
실버 티어 문제를 풀기 시작하면서 규칙을 찾는 일이 너무 어렵게 느껴진다. 전에 풀던 방식에서 벗어나지 않는 방식으로 풀어나가는데, 이렇게 풀면 답을 못구한다는 걸 느끼면서 어떻게 접근할 수 있을까 고민했었다. 그리고 답을 보니 '아...' 하게 되는.. 그렇다. 문제를 많이 풀어보면 느는 것일지 더 좋은 공부 방법이 없을지 생각하게 된다.